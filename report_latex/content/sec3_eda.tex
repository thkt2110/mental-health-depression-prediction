...
Để hiểu mối quan hệ giữa từng đặc trưng với biến mục tiêu, nhóm đã tiến hành phân tích hai biến (\textit{bivariate analysis}) cho các đặc trưng quan trọng nhất.
...
Ngoài phân tích từng đặc trưng riêng lẻ, nhóm tiến hành khám phá các tương tác đa biến (\textit{interaction patterns}) để hiểu sâu hơn về cơ chế tác động lên Depression.
...
Từ quá trình khám phá dữ liệu, nhóm đã rút ra các phát hiện quan trọng sau:
