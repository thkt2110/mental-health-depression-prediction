...
\begin{tabular}{lcccc}
\toprule
\textbf{Mô hình} & \textbf{Accuracy} & \textbf{F1} & \textbf{Precision} & \textbf{Recall} \\
\midrule
...
\textit{Ghi chú: Các giá trị Precision và Recall cần được bổ sung từ kết quả notebook thực nghiệm.}
...
\textbf{Nhận xét}: XGBoost (tuned) đạt Accuracy cao nhất (93,96\%) và F1-score cao nhất (0,8312). Sự chênh lệch giữa các mô hình tương đối nhỏ ($< 1\%$ Accuracy), cho thấy bước Feature Engineering đã tạo ra tập đặc trưng có chất lượng cao, giúp ngay cả các mô hình đơn giản cũng đạt kết quả tốt.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{evaluation/confusion_matrix.png}
...
\midrule
0 (Không trầm cảm) & 0,960 & 0,966 & 0,963 & 115.133 \\
1 (Trầm cảm) & 0,844 & 0,819 & 0,831 & 25.567 \\
\midrule
\textbf{Accuracy} & \multicolumn{4}{c}{\textbf{0,9396}} \\
Macro avg & 0,902 & 0,892 & 0,897 & 140.700 \\
Weighted avg & 0,939 & 0,940 & 0,939 & 140.700 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{evaluation/roc_curve.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{evaluation/shap_summary.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{evaluation/shap_bar.png}
...
Để minh họa khả năng giải thích ở mức \textit{individual prediction}, nhóm tác giả chọn hai ca cụ thể:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{evaluation/waterfall_a.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{evaluation/waterfall_b.png}
